...
int main() {
    ...
    if(!gladLoadGLLoader(GLADloadproc(glfwGetProcAddress))){
        std::cout<<"Error to initial glad";
        return -1;
    }
    glEnable(GL_DEPTH_TEST);

    Shader cubeShader("shaders/cubeShader.vert","shaders/cubeShader.frag");
    Shader skyShader("shaders/skyShader.vert","shaders/skyShader.frag");
    ...
    while(!glfwWindowShouldClose(window)){
        ...
        skyShader.setMat4fv("view",view);
        skyShader.setMat4fv("projection", projection);
